...
export const ROUTE_PERMISSION_RULES: RoutePermissionRule[] = [
  ...
  { path: "/dashboard", permissions: [Permission.DASHBOARD_VIEW], mode: "any", module: "dashboard" },
  ...
  { path: "/dashboard", permissions: [Permission.USERS_VIEW, Permission.DEPARTMENTS_VIEW, Permission.DEPARTMENTS_MANAGE], mode: "any", module: "users" },
  ...
  { path: "/dashboard", permissions: [Permission.ANALYTICS_VIEW, Permission.ANALYTICS_EXECUTIVE_VIEW], mode: "any", module: "analytics" },
  { path: ROUTES.REPORTS, permissions: [Permission.REPORTS_VIEW], mode: "any", module: "reports" },
  { path: "/dashboard", permissions: [Permission.ANALYTICS_EXECUTIVE_VIEW], mode: "any", module: "analytics" },
  ...
  { path: "/dashboard", permissions: [Permission.LEARNING_COURSES_VIEW, Permission.LEARNING_COURSES_MANAGE, Permission.COURSES_MANAGE], mode: "any", module: "learning" },
];
